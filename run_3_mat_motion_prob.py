...
program_list = ["rm -rf test1", "rm -rf test2", "rm -rf test3",
                "python3 3_mat_motion_prob.py -tao_type blmvm -tao_monitor -tao_max_it 2000 -tao_gatol 1e-7 -lr 2.6 -ls 0.160 -m 'motion_mesh2.msh' -o 'test1' -er 1.0 -es 1.0e-2 -k 2.2e-3 -e 4.0e-3 -p 2.0"]
