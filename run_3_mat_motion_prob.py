...
program_list = ["rm -rf test1", "rm -rf test2", "rm -rf test3",
                "python3 3_mat_motion_prob.py -tao_monitor -tao_max_it 500 -lr 3.0 -ls 0.6 -m 'motion_mesh.msh' -o 'test1' -er 1.0 -es 1.0e-1 -k 2.2e-3 -e 4.0e-3 -p 2.0",
                "python3 3_mat_motion_prob.py -tao_monitor -tao_max_it 500 -lr 3.0 -ls 0.7 -m 'motion_mesh.msh' -o 'test2' -er 1.0 -es 1.0e-1 -k 2.2e-3 -e 4.0e-3 -p 2.0",
                "python3 3_mat_motion_prob.py -tao_monitor -tao_max_it 500 -lr 3.0 -ls 0.8 -m 'motion_mesh.msh' -o 'test3' -er 1.0 -es 1.0e-1 -k 2.2e-3 -e 4.0e-3 -p 2.0"]
