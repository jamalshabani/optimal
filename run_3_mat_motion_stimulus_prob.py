...
# Ratio Er/Es = 10.0
program_list = ["python3 3_mat_motion_stimulus_prob.py -tao_type blmvm -tao_monitor -tao_max_it 5000 -tao_gatol 1e-7 -lr 2.6 -ls 0.130 -m 'motion_mesh.msh' -o 'test1_static_stimulusId' -er 1.0 -es 1.0e-2 -k 1.9e-3 -e 4.0e-3 -p 2.0 -a 0.0",
                "python3 3_mat_motion_stimulus_prob.py -tao_type blmvm -tao_monitor -tao_max_it 5000 -tao_gatol 1e-7 -lr 2.6 -ls 0.130 -m 'motion_mesh.msh' -o 'test2_static_stimulusId' -er 1.0 -es 1.0e-2 -k 2.0e-3 -e 4.0e-3 -p 2.0 -a 0.0"]
