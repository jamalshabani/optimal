...
# Ratio Er/Es = 10.0
program_list = ["python3 3_mat_res_prob.py -tao_monitor -tao_max_it 400 -l1 10.0e-3 -l2 10.0e-2 -m '1_to_3_mesh.msh' -o 'test' -e1 1.0 -e2 1.0e-1 -k 1.0e-2 -e 4.0e-3 -p 3.0",]
