...
# Ratio Er/Es = 10.0
program_list = [#"python3 blocking_load_2_mat.py -tao_monitor -tao_max_it 200 -l 0.025 -m '1_to_3_mesh.msh' -o '1_to_3_mesh' -er 1.0 -es 1.0e-1 -k 1.0e-5 -e 4.0e-3 -p 1.0",]
