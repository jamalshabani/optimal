...
# Ratio Er/Es = 10.0
program_list = ["rm -rf motion_test1_kI",
                "python3 motion_3_mat_stimulus_kI_problem.py -tao_type blmvm -tao_monitor -tao_max_it 1500 -tao_gatol 1e-7 -lr 2.0 -ls 0.2 -m 'motion_mesh.msh' -o 'motion_test1_kI' -er 1.0 -es 1.0e-2 -k 1.7e-3 -e 4.0e-3 -p 2.0 -s 0.0"]
